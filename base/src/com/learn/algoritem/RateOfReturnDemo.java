...
public class RateOfReturnDemo {
    ...
    private static void init() {
        ...
        rand.doubles(500).limit(500).forEach(value ->
                {
    ...
    private static void violence() {
        ...
        System.out.println("origin:" + rateOfReturn.get(origin) + ", dest:" + rateOfReturn.get(dest) + ", maxRateOfReturn:" + maxRateOfReturn);
    }
